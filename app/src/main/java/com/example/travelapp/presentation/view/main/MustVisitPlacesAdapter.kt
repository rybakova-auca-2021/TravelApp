...
import com.example.travelapp.databinding.MustVisitCardBinding

class MustVisitPlacesAdapter(private var items: List<PlaceModel>) :
    RecyclerView.Adapter<MustVisitPlacesAdapter.ItemsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemsViewHolder {
        ...
        val binding = MustVisitCardBinding.inflate(inflater, parent, false)
    ...
    inner class ItemsViewHolder(private val binding: MustVisitCardBinding) :
