...
class GetPopularListViewModel(private val repository: MainRepository) : ViewModel() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    _result.postValue(Result.failure(Throwable("Failed to get the list of popular places")))
                }
            } catch (e: Exception) {
