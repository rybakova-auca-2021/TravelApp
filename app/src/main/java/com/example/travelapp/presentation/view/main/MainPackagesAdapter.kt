...
import com.example.travelapp.databinding.MainPackageCardBinding
import com.example.travelapp.databinding.PlaceCardBinding

class MainPackagesAdapter(private var items: List<PlaceModel>) :
    RecyclerView.Adapter<MainPackagesAdapter.PlacesViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlacesViewHolder {
        ...
        val binding = MainPackageCardBinding.inflate(inflater, parent, false)
    ...
    inner class PlacesViewHolder(private val binding: MainPackageCardBinding) :
